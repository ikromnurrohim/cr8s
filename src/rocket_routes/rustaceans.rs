...
pub async fn get_rustaceans(mut db: Connection<DbConn>, user: User) -> Result<Value, Custom<Value>> {
...
pub async fn view_rustacean(id: i32, mut db: Connection<DbConn>, user: User) -> Result<Value, Custom<Value>> {
...
pub async fn create_rustacean(new_rustacean: Json<NewRustacean>, mut db: Connection<DbConn>, user: User) -> Result<Custom<Value>, Custom<Value>> {
...
pub async fn update_rustacean(id: i32, rustacean: Json<Rustacean>, mut db: Connection<DbConn>, user: User) -> Result<Value, Custom<Value>>{
...
pub async fn delete_rustacean(id: i32, mut db: Connection<DbConn>, user: User) -> Result<NoContent, Custom<Value>> {
